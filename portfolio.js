...
function calculate() {
    ...
    var listePrix = document.getElementByClassName("prix");
    var listeQte = document.getElementByClassName("qte");
    var listeDesc = document.getElementByClassName("desc");
    ...
    //Partie A FAIRE
function ajouterLingne(){
    var NewLi = document.getElementById("modeLigne").cloneNode(true);
...
function remplir(){
    ...
    for(var i=0); i< listeDesc.length; i++{
        ...
        var idesc = Math.floor(tabDesc.length * Math.random()); // Nombre entre 0 et le nombre d'élément -1 de tabDesc
